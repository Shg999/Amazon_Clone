                    ...
                    sidebar &&(
                        ...
                        bg-amazon_blue bg-opacity-50'>
                            <div className='w-full h-full relative'>
                                ...
                                transition={{duration: .5}} className='w-[80%] md:w-[350px] h-full bg-white border border-black'>
                                ...
                                <span onClick={()=>setSidebar(false)} className='cursor-pointer absolute top-0 left-[82%] mdl:left-[360px] w-10 h-10 text-black 
