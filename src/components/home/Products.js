...
const Products = () => {
    ...
    return (
        <div className='max-w-screen-2xl mx-auto grid grid-cols-1 mdl:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-10 px-4'>
            {
                productData.map((item) => (
                    <div key={item.id} className='bg-white h-auto boredr-[1px] border-gray-200 py-8 z-30
                    hover:border-transparent shadow-none hover:shadow-textShadow duration-200 flex flex-col gap-4 relative'>
                        ...
                        <div className='w-full h-auto flex items-center justify-center relative group'>
                           ...
                           font-titleFont px-2 border-l border-r group-hover:bottom-0 duration-700'>
                        ...
                        from-yellow-400 to-yellow-200 border hover:from-yellow-300 to-yellow-400
                        border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl
                        active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-5'>
                            Add to Cart</button>
                    </div>
                    </div>
                ))
